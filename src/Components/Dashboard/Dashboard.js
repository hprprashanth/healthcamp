...
const Dashboard = () => {
    ...
    const selectedDateAppointment = appointment.filter(appointment => (appointment.details && appointment.details.date) === fullTodaysDate);
                                            ...
                                            <TableBody>
                                                {
                                                    appointment.map((appoint) => (
                                                        <TableRow key={appoint._id}>
                                                            ...
                                                            <TableCell align="center">{(appoint.details && appoint.details.date) || ""}</TableCell>
                                                            <TableCell align="center">{(appoint.details && appoint.details.time) || ""}</TableCell>
                                                            <TableCell align="left">{(appoint.details && appoint.details.name) || ""}</TableCell>
                                                            <TableCell align="center">{(appoint.details && appoint.details.phoneNumber) || ""}</TableCell>
